...
/** Defines an interface to implement executors based on Workers
  * (e.g. Docker/Kubernetes).
  * [[WorkerBasedExecutor]] uses this to create an instance of [[ai.mantik.executor.Executor]]
  */
trait WorkerExecutorBackend extends Component {
