...
def create_bridge_app(mantikfile: mantik.Mantikfile, algorithm: Algorithm) -> Flask:
    """
    ...
    def apply():
        ...
        result = (result or mantik.Bundle()).with_type_if_missing(mantikfile.type.output)
